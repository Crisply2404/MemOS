  ...
  return (
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-2">
        <Badge color="purple">{asString(pack.schema) || 'context_pack'}</Badge>
      ...
      <div className="grid grid-cols-1 gap-3">
        ...
        <div className="bg-black/20 border border-mem-border rounded-lg p-3">
          <div className="text-[10px] uppercase tracking-wider text-gray-400 mb-2">Episodic Summary (Session)</div>
