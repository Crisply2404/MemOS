...
建议后端目录结构：`server/`（同仓库），包含 FastAPI、Worker、迁移脚本与 `docker-compose`（Postgres + Redis）。<div align="center">
...
View your app in AI Studio: https://ai.studio/apps/drive/1GBv3gcMSTCwkXUhaIzf2NpwznYFMo42r
